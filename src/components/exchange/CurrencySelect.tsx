...
const ButtonDisplay = memo(({ icon, name }: Currency) => (
  <span className="button-display flex items-start gap-6 overflow-hidden text-ellipsis text-16 text-black">
  ...
  return (
    <BaseSelect
      ...
      renderTrigger={({ isOpen }) => (
        <button
          type="button"
          className="w-full flex [&_.button-display]:items-center items-center justify-between px-16 py-10 border-l border-[#B5B5B5] bg-[#FFFFFF] text-16"
