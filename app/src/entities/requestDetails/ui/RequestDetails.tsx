  ...
  ({ title, rate, currency }) => {
    return (
      <div className="">
        ...
        <div className="bg-[#FFFFFF] rounded-6 px-20 py-24 flex flex-col gap-20">
          <div>
            <div className="mb-15 flex  items-center justify-between">
              <div className="flex  items-center gap-6">
                ...
                ></Icon>
                <span className="text-16 leading-normal text-black">
                  {currency.name}
                </span>
              </div>
            ...
            <span className="text-21 leading-normal text-black font-normal">{currency.value}</span>
          </div>
          {currency.wayDetails && (
            <div>
              ...
              <span
                className={clsx("break-all text-16 leading-normal text-black", {
