...
import { useExchangeInput, usePlaceholder, normalizeInput, formatWithSpacesCardNumber, formatPhoneNumber } from "@/shared/lib";
import { useAppDispatch, useAppSelector, selectSectionHeadingProps, selectCurrencyOptions, selectBankOptions, selectBankValue, selectCardNumberValue, selectPhoneNumberValue, selectIsPhoneNumberUsed, selectBankError, selectCardNumberError, selectPhoneNumberError, setCardNumberValue, setPhoneNumberValue, setSelectedBankValue } from "@/shared/model/store";
