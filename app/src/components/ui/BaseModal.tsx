...
const BaseModal = ({
  ...
  const element = <div
    ...
    >
      ...
      >
        ...
        <Button disabled={isSubmitButtonDisabled} type="primary" onClick={handleButton || handleClose}>
          {buttonText}
        </Button>
      { !isCloseButtonHidden && <button
  ...
  return body.current ? createPortal(element, body.current) : null;
};
